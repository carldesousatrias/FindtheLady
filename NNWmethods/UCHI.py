...
class Uchi_tools():
    ...
    def training(self, net, trainloader, optimizer, criterion, watermarking_dict):
        '''
    ...
    tools.init(network,watermarking_dict)
    # np.save(save+".npy",watermarking_dict)
    print(tools.detection(network,watermarking_dict))
    '''